...
id: debug
version: 2.0.0
description: Debug code issues, test failures, or behavioral problems
metadata:
  author: system
  ...
  migrated_from:
    ...
    instructions: [instructions/core/debug-issue.md]
    migration_date: Sun Aug 31 21:39:36 EDT 2025
...
hooks:
  session_start: pre-flight
  pre_execution: optional  
  post_execution: post-flight
  error_handling: optional
  
cross_references:
  meta_instructions: ["pre-flight","post-flight","spec-validation"]
...
<!-- ========================================
     EMBEDDED FROM: instructions/core/debug-issue.md
     ======================================== -->
...
This command previously referenced external instruction files.
All instructions are now embedded above for reliability and performance.
